...
from scene.dataset_readers import readRFSceneInfo, readBLESceneInfo, readCSISceneInfo

# ---- Scene class: manages dataset, gaussians, and checkpoints ----
class Scene:
    ...
    def __init__(self,
        ...
        # load saved point cloud or initialize from scene info
        if self.loaded_iter:
